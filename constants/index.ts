...
export const STATS = [
  { value: "200+", label: "Trusted Farmers" },
  { value: "15+", label: "Export Countries" },
  { value: "500MT", label: "Monthly Capacity" },
...
export const TRUST_FEATURES = [
  {
    ...
    description:
      "Every batch meets international phytosanitary and quality standards before leaving our facility.",
  },
  {
    icon: "Users",
    title: "Direct Farmer Sourcing",
    description:
      "We work directly with 200+ verified farmers, eliminating middlemen for fresher produce and better prices.",
  },
  {
    icon: "Globe",
  ...
  },
  {
    ...
    description:
      "Consistent year-round supply backed by our established farmer network across Tamil Nadu.",
  },
  {
    icon: "Package",
  ...
  {
    icon: "Zap",
    title: "Fast Air & Sea Freight",
    description:
      "Optimized logistics with temperature-controlled shipping to preserve freshness across global destinations.",
  },
];
...
export const PRODUCTS = [
  {
    ...
    specs: {
      ...
      "Export Standard": "EU / GCC / APEDA compliant",
    },
    exportCountries: ["UAE", "Saudi Arabia", "UK", "Germany", "Singapore", "Malaysia"],
  },
  {
    id: "curry-leaves",
    ...
    exportCountries: ["UAE", "Qatar", "UK", "Netherlands", "Australia", "Canada"],
  },
];
...
export const EXPORT_STEPS = [
  {
    ...
    description:
      "We partner with verified farmers across Tamil Nadu who grow under our quality guidelines.",
    icon: "Sprout",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    description:
      "Produce is cleaned, sorted by grade, and prepared in our hygienic processing facility.",
    icon: "Filter",
  },
  {
    number: "04",
    title: "Packaging",
    description:
      "Custom export-grade packaging with moisture control and proper labeling for destination markets.",
    icon: "Package",
  },
  {
    number: "05",
  ...
  },
  {
    ...
    description:
      "Temperature-controlled shipping via air or sea freight to over 15 countries worldwide.",
    icon: "Plane",
  },
  {
    number: "07",
    title: "Delivery",
    description:
      "Products arrive fresh at their destination, ready for retail, distribution, or further processing.",
    icon: "MapPin",
  },
];
...
export const WHY_CHOOSE_US = [
  { icon: "ShieldCheck", title: "Verified Farmer Network", desc: "200+ trusted growers with traceable supply" },
  { icon: "Search", title: "Strict Quality Control", desc: "Multi-stage inspection at harvest and facility" },
  { icon: "BadgeDollarSign", title: "Competitive Pricing", desc: "Farm-direct sourcing eliminates middlemen" },
  { icon: "Globe", title: "Global Shipping", desc: "Air and sea freight to 15+ countries" },
  { icon: "MessageCircle", title: "Responsive Communication", desc: "Dedicated support via email and WhatsApp" },
  { icon: "Leaf", title: "Always Fresh", desc: "Harvested to order for peak freshness" },
  { icon: "Package", title: "Bulk Supply Ready", desc: "Handle trial to full container loads" },
  { icon: "Heart", title: "Long-term Partnerships", desc: "We grow with our buyers' businesses" },
];
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "We offer custom export-grade packaging including 2kg, 5kg, and 10kg cartons with moisture control and proper labeling. We can accommodate destination-specific packaging requirements.",
  },
  {
...
export const EXPORT_REGIONS = [
  { name: "Middle East", countries: ["UAE", "Saudi Arabia", "Qatar", "Kuwait", "Bahrain", "Oman"], color: "#1D6F42" },
  { name: "Europe", countries: ["UK", "Germany", "Netherlands", "France", "Belgium"], color: "#1D6F42" },
  { name: "Southeast Asia", countries: ["Malaysia", "Singapore", "Indonesia", "Thailand"], color: "#1D6F42" },
  { name: "North America", countries: ["USA", "Canada"], color: "#1D6F42" },
  { name: "Africa", countries: ["South Africa", "Kenya", "Ethiopia"], color: "#1D6F42" },
];
